...
<html>
    ...
    <body bgcolor="lightsteelblue">
       ...
       <tr><td>OTP link is sent to the mail   <%=sess.getAttribute("mail")%></td><td></td></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
    <tr><td>Enter OTP: <input type="number" name="OTP"/></td><td></td></tr><br><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
    </table><span style="position:absolute;top:400px;left:300px;border:0"> </span>
    <span style="position:absolute;top:400px;left:570px;border:0"><input type="submit" value="submit"/> </span>
    <span style="position:absolute;top:400px;left:670px;border:0"><input type="button" value="Resend Mail" onclick="location.href='ResendOTPlink.jsp';"/>
            </span>
    <span style="position:absolute;top:400px;left:770px;border:0"><input type="button" value="cancel" onclick="location.href='main.jsp';"/>
        </span>
